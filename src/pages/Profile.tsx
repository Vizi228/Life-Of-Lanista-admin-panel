                ...
                <FlexboxGrid justify='center' align='middle' style={{ height: '94.2vh' }}>
                    <FlexboxGrid.Item colspan={8}>
                        <Panel header={<h3 style={{ textAlign: 'center' }}>Settings</h3>} bordered>
                            <ButtonToolbar style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-around', minHeight: '100px' }}>
                                <ModalComponent onClickButton={handleChangePassword} title='Change Password' name='Change Password'>
                                    <Form
                                        ref={formRef}
                                    ...
                                    >
                                        ...
                                        <TextField type={'password'} name='password' isPassword={true} aria-label='Password' />
                                        <TextField type={'password'} name='changePassword' isPassword={true} aria-label='New Password' />
                                    </Form>
                                </ModalComponent>
